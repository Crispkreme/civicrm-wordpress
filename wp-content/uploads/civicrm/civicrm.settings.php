...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/project_civicrm?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['wp.frontend.base']['url'] = 'http://localhost/civicrm/';
$civicrm_paths['wp.backend.base']['url'] = 'http://localhost/civicrm/wp-admin/';
$civicrm_setting['domain']['userFrameworkResourceURL'] = 'http://localhost/civicrm/wp-content/plugins/civicrm/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost/project_civicrm?new_link=true');
  }
}
...
$civicrm_root = 'C:\\xampp\\htdocs\\civicrm\\wp-content\\plugins\\civicrm/civicrm\\';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:\\xampp\\htdocs\\civicrm/wp-content/uploads\\civicrm\\templates_c');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '45WpSGVWdS5grQ5osTpQY9Nj7q1fuGxLgEGTf0mIH8');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:7XuPxpCl2cyuE1jlenuHlpH7IUm1rX1SzbogqgX2jVaMSCb0PQ');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:Qudp4NWS53omb7tX99BQzNs7cV9jvGUBGoNDuACwenCQepNXgsjTdA');
...
// define( 'CIVICRM_MAIL_LOG', 'C:\\xampp\\htdocs\\civicrm/wp-content/uploads\\civicrm\\templates_c/mail.log');
// }
