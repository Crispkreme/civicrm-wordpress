 ...
 * @final
 */
class CachedCiviContainer_95624fd07ff70e41eda365c38436e5a5 extends Container
{
    private $parameters = [];
    ...
    {
        return $this->services['cache.metadata'] = \CRM_Utils_Cache::create(['name' => 'metadata_5_55_2', 'type' => [0 => '*memory*', 1 => 'SqlGroup', 2 => 'ArrayCache'], 'withArray' => 'fast']);
    }
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberServiceMap('civi.api4.validateFields', ['civi.api.prepare' => [0 => [0 => 'onApiPrepare']]]);
    ...
    {
        return [
            'civicrm_base_path' => 'C:\\xampp\\htdocs\\civicrm\\wp-content\\plugins\\civicrm\\civicrm',
        ];
    }
}
